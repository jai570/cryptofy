      ...
      <div className="flex md:flex-row flex-col items-start justify-between md:p-20 py-12 px-4">
        <div className="flex flex-1 justify-start flex-col md:mr-10">
          ...
          <p className="text-left mt-4 text-white font-light md:w-9/12 w-11/12 text-base">
            Explore thr Crypto world Buy and sell crypto easily on my Web 3.0
            app
          </p>
          ...
          <div className="grid sm:grid-cols-3 grid-cols-2 w-full mt-10">
            ...
            <div className={`${commonStyles} rounded-br-2xl`}>Bockchain</div>
          </div>
        </div>
        <div className="flex flex-col flex-1 items-center justify-start w-full md:mt-0 mt-10">
          <div className="justify-end p-3 items-start flex-col rounded-xl h-40 sm:w-72 w-full my-5 eth-card white-glassmorphism">
